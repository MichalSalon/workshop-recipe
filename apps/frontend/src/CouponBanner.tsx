...
export function CouponBanner({ embedded = false }: CouponBannerProps) {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_50%_0%,rgba(2,179,164,0.14),transparent)]"
      />
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="min-w-0 space-y-4">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
              <div className="rounded-xl border-2 border-primary/40 bg-card px-6 py-4 shadow-[0_0_40px_-8px_rgba(2,179,164,0.25)]">
              ...
              <div className="flex items-center gap-4 sm:gap-6">
                <div className="text-center">
                  <p className="text-xs uppercase tracking-wider text-muted-foreground">Usually</p>
                  <p className="mt-1 text-2xl font-semibold text-muted-foreground line-through sm:text-3xl">
                    ${coupon.defaultTotalUsd}
                  </p>
                  <p className="text-xs text-muted-foreground">${coupon.defaultBonusUsd} bonus</p>
                </div>
          ...
          <div className="flex shrink-0 flex-col gap-3 sm:flex-row lg:flex-col">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-12 border-border bg-background px-8 text-base text-foreground hover:bg-muted hover:text-foreground"
